package HW5.Domain_Model;

// Пример использования классов модели домена
public class Main {
    public static void main(String[] args) {
        // Создаем клиента
        Customer customer = new Customer("1", "Леонид Смирнов");
        
        // Создаем продукты
        Product product1 = new Product("1", "Холодильник", 35000.0);
        Product product2 = new Product("2", "Телевизор", 15000.0);
